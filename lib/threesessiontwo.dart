    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              Container(
                margin: EdgeInsets.only(left: 10,right: 10),
                child: Text("The word comes from the bangla word 'Abotar'.An avatar is an  symbolic image used for virtual identity instead of one's own image ",
                textAlign: TextAlign.center,
              ...
              GestureDetector(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Center(child: Container(child: Text("Click Here",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),))),
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Image.asset("assets/mygov.png",)),
