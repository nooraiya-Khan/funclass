import 'package:demo/pttwo.dart';
              ...
              child: Column(children: [
                ...
                Container(
                  child: Text(
                    "let's watch a video!!",
                    style: TextStyle(
                        color: Color.fromARGB(255, 131, 46, 184), fontSize: 25),
                  ),
                ),
                SizedBox(
                  height: 15,
                ...
                Text("You can also visit the official website (dpdt.gov.bd) for trademark registration",
                textAlign: TextAlign.center,
                ),
                SizedBox(height: 20,),
                Row(
                                          ...
                                          onTap: () {
                                            setState(() {
                                              if (namecontroller.text == "") {
                                                ...
                                                isEmailBlank = false;
                                                isEmailInvalid = false;
                                                isProductDescriptionBlank =false;
                                                isSigBlank = false;
                                                nationalityOkMsg;
                                                ...
                                                isEmailBlank = false;
                                                isEmailInvalid = false;
                                                isProductDescriptionBlank =true;
                                                isSigBlank = false;
                                                descriptionOkmsg;
